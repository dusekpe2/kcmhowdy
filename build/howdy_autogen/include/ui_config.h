...
public:
    ...
    void setupUi(QWidget *ConfigForm)
    {
        ...
        comboDevicePath = new QComboBox(videoGroup);
        comboDevicePath->setObjectName(QStringLiteral("comboDevicePath"));

        gridLayout_5->addWidget(comboDevicePath, 3, 1, 1, 1);
